defmodule Admin do
  @moduledoc """
  The admin system for the platform.

  This is entrypoint for defining the web interface to the
  content management system, such as controllers, views,
  channels and so on.
  ...
  controller, etc, so keep them short and clean, focused on
